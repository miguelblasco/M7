...
public class View {
	...
	private Car getCar() {
		String plate = JOptionPane.showInputDialog("Introduzca la matrícula del coche");
	...
	private Wheel getWheel() throws Exception {
		...
		double diameter = Double.parseDouble(JOptionPane.showInputDialog("Introduzca diámetro de la rueda"));
